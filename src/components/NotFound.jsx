...
const NotFound = () => {
    return (
        <Box className="page_404" sx={{ padding: '40px 0', backgroundColor: 'transparent' }}>
            <Container>
                ...
                <Box textAlign="center" className="contant_box_404" sx={{ marginTop: '-50px' }}>
                    ...
                    <Button component={Link} to="/dashboard" variant="contained" color="primary" className="link_404">Go to Home</Button>
                </Box>
            </Container>
        </Box>
    );
