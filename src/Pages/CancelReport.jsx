...
export default function CancelReport() {
 ...
 const handleExport = async () => {
  try {
    ...
    const url = `http://localhost:8052/api/cnl/download-excel?${params.toString()}`;
      ...
      >
            ...
            <Grid item xs={12} md={8}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                ...
                <Box>
                  ...
                  >
                    Generate and export cancel job tracker report
                  </Typography> */}
                </Box>
              </Box>
            </Grid>
        ...
        >
          ...
          >
            ...
            >
              Select filters and export the cancel report
            </Typography>
          </Box>
